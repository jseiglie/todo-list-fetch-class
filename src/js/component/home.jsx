...
const Home = () => {
	...
	const [editing, setEditing] = useState(); // state that will hold the id of the todo to edit
	...
	*/
	...
	return (
		<div className="text-center">
			<div className="d-flex flex-column ms-auto my-3 w-25 p-3">
				...
				<div className="d-flex">
					...
					<button className="btn btn-success" onClick={handleUser}>START!</button>
				</div>
			</div>
							...
							<div>
								...
								{editing == el.id ?
									...
									<div>
										...
										<li className="list-group-item  d-flex justify-content-between">{el.label}
											<span className="mx-3">
